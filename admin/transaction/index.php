        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped" id="indi-list">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT t.*,concat(a.firstname ,' ', a.middlename,' ', a.lastname) as `name`,a.account_number from `transactions` t inner join `accounts` a on a.id = t.account_id order by unix_timestamp(t.date_created) desc ");
